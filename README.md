...
| [`learn/`](learn/) — [index](learn/README.md) | **the Entroptics course, as files.** 49 lessons from grade-ten mathematics to a working instrument. Start at the [index](learn/README.md), or [`learn/index.html`](learn/index.html) for the browsable door — both list the same 49. Every page is a plain file, with no server and no account | work in progress |
